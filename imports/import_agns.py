...
from hipscat_import.file_readers import FitsReader


def do_import():

    filename = "/home/delucchi/td_data/agns/dr7_bh_May_2011.fits.gz"
    multidimensional = [
        "UGRIZ",
        "UGRIZ_ERR",
        "UGRIZ_DERED",
...
def read_fits():
    # filename = "/home/delucchi/td_data/agns/dr16q_prop_Oct23_2022.fits.gz"
    # multidimensional = [
    #     "CONTI_FIT",
    #     "CONTI_FIT_ERR",
    #     "CONTI_STAT",
    ...
    # print(len(table))
    # table2 = table[:100]
    # table2.remove_columns(multidimensional)
